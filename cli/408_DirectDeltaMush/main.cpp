...
{
  argparse::ArgumentParser program("408_DirectDeltaMush");
  program.add_argument("-i", "--input").required().help("Path to mesh file");
  program.add_argument("--tgf").required().help("Path to tgf file");
  program.add_argument("--weights").required().help("Path to weights file");
  program.add_argument("--anim").required().help("Path to anim file");
  ...
  igl::readTGF(           program.get<std::string>("--tgf"),C,BE);
  igl::readDMAT(          program.get<std::string>("--weights"),W);
  igl::readDMAT(          program.get<std::string>("--anim"),T);
