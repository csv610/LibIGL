...
int main(int argc, char *argv[])
{
  ...
  argparse::ArgumentParser program("810_BlueNoise");
  program.add_argument("-i", "--input").required().help("Path to input mesh file");
  program.add_argument("--num_points").default_value(50000).help("Number of points for blue noise");
  try {
  ...
  int n_desired = program.get<int>("--num_points");
